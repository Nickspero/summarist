    ...
    <div className="wrapper">
      ...
      <div className="row">
        <div className="container">
            {bookInfo? <div className="inner__wrapper">
            <div className="inner__book">
              ...
              <div className="inner-book__wrapper">
                <div className="inner-book__description--wrapper">
                  <div className="inner-book__description">
                    ...
                    <div className="inner-book__description--text">{bookInfo.averageRating} ({bookInfo.totalRating} Ratings)</div>
                  </div>
                  <div className="inner-book__description">
                  ...
                  <div className="inner-book__description">
                    ...
                    <div className="inner-book__description--text">{bookInfo.type}</div>
                  </div>
                  <div className="inner-book__description">
                    <div className="inner-book__icon"><PiLightbulbFilament/></div>
                    <div className="inner-book__description--text">{bookInfo.keyIdeas} Key Ideas</div>
                  </div>
                </div>
              </div>
              <div className="inner-book__read--btn-wrapper">
                <Link href={isPremium || !bookInfo.subscriptionRequired?`/player/${id}`:"/choose-plan"}>
                <button className="inner-book__read--btn">
                  <div className="inner-book__read--icon"><PiBookOpenText/></div>
              ...
              <div className="inner-book__tags--wrapper">
                {bookInfo.tags.map((tag:string) => (
                    <div key={tag} className="inner-book__tag">{tag}</div>
                ))}
              </div>
            ...
            <div className="inner-book--img-wrapper">
              <figure className="book__image--wrapper">
                <img className="book__image" src={bookInfo.imageLink} alt="" />
              </figure>
            </div>
          </div> : <BookPageSkeleton/>}
